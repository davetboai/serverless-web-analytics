...
- Deploy: `cd cdk && source .venv/bin/activate && cdk deploy --all -c domain_name=analytics.example.com -c hosted_zone_id=<id> -c hosted_zone_name=example.com -c certificate_arn=<arn> -c dashboard_password=<pw>`
