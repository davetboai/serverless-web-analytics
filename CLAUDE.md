...
- Deploy: `cd cdk && source .venv/bin/activate && cdk deploy --all -c domain_name=analytics.example.com -c hosted_zone_id=<id> -c hosted_zone_name=example.com -c certificate_arn=<arn> -c cognito_user_pool_id=<pool_id> -c cognito_client_id=<client_id>`
